...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        MainWindow.resize(315, 445)
        MainWindow.setMinimumSize(QSize(315, 445))
        MainWindow.setMaximumSize(QSize(315, 445))
        ...
        self.tableDiceStats.setGeometry(QRect(90, 80, 207, 356))
        font = QFont()
        ...
        self.labelRollStatsStatic.setGeometry(QRect(90, 50, 146, 29))
        font1 = QFont()
        ...
        self.labelRollsStatic.setGeometry(QRect(10, 50, 57, 29))
        self.labelRollsStatic.setFont(font1)
        self.labelRollsStatic.setText(u"Rolls:")
        self.listRolls = QListWidget(self.centralwidget)
        self.listRolls.setObjectName(u"listRolls")
        self.listRolls.setGeometry(QRect(10, 80, 51, 356))
        font2 = QFont()
