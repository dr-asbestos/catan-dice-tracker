...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        MainWindow.resize(1205, 505)
        MainWindow.setMinimumSize(QSize(1205, 505))
        MainWindow.setMaximumSize(QSize(1205, 505))
        ...
        self.tableDiceStats.setGeometry(QRect(190, 140, 1007, 356))
        font = QFont()
        ...
        self.labelRollStatsStatic.setGeometry(QRect(190, 110, 146, 29))
        font1 = QFont()
        ...
        self.labelRollsStatic.setGeometry(QRect(10, 110, 169, 29))
        ...
        self.buttonDeleteLastRoll.setGeometry(QRect(220, 10, 131, 31))
        ...
        self.tableRolls.setGeometry(QRect(10, 140, 171, 356))
        ...
        self.labelPlayerTotalsStatic = QLabel(self.centralwidget)
        self.labelPlayerTotalsStatic.setObjectName(u"labelPlayerTotalsStatic")
        self.labelPlayerTotalsStatic.setGeometry(QRect(370, 10, 69, 29))
        self.labelPlayerTotalsStatic.setFont(font1)
        self.labelPlayerTotalsStatic.setText(u"Totals:")
        self.tableTotalStats = QTableWidget(self.centralwidget)
        self.tableTotalStats.setObjectName(u"tableTotalStats")
        self.tableTotalStats.setGeometry(QRect(450, 10, 368, 120))
        self.tableTotalStats.setFont(font2)
        self.tableTotalStats.setFrameShape(QFrame.Shape.Box)
        self.tableTotalStats.setLineWidth(1)
        self.tableTotalStats.setVerticalScrollBarPolicy(Qt.ScrollBarPolicy.ScrollBarAlwaysOff)
        self.tableTotalStats.setHorizontalScrollBarPolicy(Qt.ScrollBarPolicy.ScrollBarAlwaysOff)
        self.tableTotalStats.setEditTriggers(QAbstractItemView.EditTrigger.NoEditTriggers)
        self.tableTotalStats.setTabKeyNavigation(False)
        self.tableTotalStats.setProperty(u"showDropIndicator", False)
        self.tableTotalStats.setDragDropOverwriteMode(False)
        self.tableTotalStats.setAlternatingRowColors(True)
        self.tableTotalStats.setSelectionMode(QAbstractItemView.SelectionMode.NoSelection)
        self.tableTotalStats.setSelectionBehavior(QAbstractItemView.SelectionBehavior.SelectItems)
